...
window.THREE.JeelizHelper=(function(){
  //internal settings
  const _settings={
    rotationOffsetX: 0, //negative -> look upper. in radians
    pivotOffsetYZ: [0.8,0.2], //[0.2,0.2], //XYZ of the distance between the center of the cube and the pivot. enable _settings.isDebugPivotPoint to set this value
